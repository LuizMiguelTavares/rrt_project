...
class DifferentialController:
    ...
    def control_loop(self):
        while not rospy.is_shutdown():
            ...
            robot_pose_control = robot_pose_center
            ...
            # print(X_dot_ref_w)
            reference_linear_velocity = np.cos(yaw)*X_dot_ref_w[0][0] + np.sin(yaw)*X_dot_ref_w[1][0]
            psi_desired = np.arctan2(X_dot_ref_w[1][0], X_dot_ref_w[0][0])
