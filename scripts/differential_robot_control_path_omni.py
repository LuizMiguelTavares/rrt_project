...
class DifferentialController:
    def __init__(self):
        ...
        self.max_linear_velocity_y = rospy.get_param('~max_linear_velocity_y', 0.1)
    ...
    def control_loop(self):
        while not rospy.is_shutdown():
            ...
            reference_linear_velocity_y = self.y_dot_obs
            ...
            if np.abs(reference_linear_velocity_y) > self.max_linear_velocity_y:
                reference_linear_velocity_y = np.sign(reference_linear_velocity_y)*self.max_linear_velocity_y
